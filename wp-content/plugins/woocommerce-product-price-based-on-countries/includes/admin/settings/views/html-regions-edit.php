...
<div class="settings-panel wcpbc-region-settings">
	<h2>
		<?php echo ( isset( $_GET['add_region'] ) ? esc_html__( 'Add Zone', 'wc-price-based-country' ) : esc_html__( 'Edit Zone', 'wc-price-based-country' ) ); ?>
	...
	<table class="form-table">
		...
		<tr valign="top">
	        ...
	        <td class="forminp forminp-text">
	        	<span style="line-height:30px;">1 <?php echo get_option( 'woocommerce_currency' );?> = </span><input name="exchange_rate" id="exchange_rate" type="text" class="short wc_input_decimal" value="<?php echo wc_format_localized_decimal( $region['exchange_rate'] ); ?>" style="width: 348px;" />
