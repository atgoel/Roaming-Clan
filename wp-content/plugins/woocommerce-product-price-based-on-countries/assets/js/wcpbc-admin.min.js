...
{action:"wcpbc_hide_notice",security:a(this).data("nonce"),notice:a(this).data("notice"),remind:a(this).hasClass("remind-later")?"yes":"no"},function(){a(c).removeClass("updating");a(c).fadeOut(100)})});a(".wc-price-based-country-setting-wrapper-ads .wc-price-based-country-setting-content").append(a(".wc-price-based-country-setting-wrapper-ads").siblings("p.submit"))});