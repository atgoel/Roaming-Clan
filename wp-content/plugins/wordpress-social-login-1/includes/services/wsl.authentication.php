...
function wsl_process_login()
{
	...
	{
		return wsl_process_login_render_notice_page( sprintf( _wsl__( "You have to be logged in to be able to link your existing account. Do you want to <a href='%s'>login</a>?", 'wordpress-social-login' ), ' ' ) );
	}
...
function wsl_process_login_get_redirect_to()
{
	...
	return 'https://roamingclan.com/roamingclan-my-account/edit-account/';
}
