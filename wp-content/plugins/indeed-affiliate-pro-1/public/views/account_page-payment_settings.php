<div class="uap-ap-wrap">
	...
	<form action="" method="post" class="uap-change-password-form">
		<div class="uap-ap-field">
			...
			?>
			<option value="bt" <?php echo ($data['metas']['uap_affiliate_payment_type']== 'bt') ? 'selected' : '';?>>Bank Transfer</option>
			<option value="paypal" <?php echo ($data['metas']['uap_affiliate_payment_type']== 'paypal') ? 'selected' : '';?>>Paypal</option>
			<?php
			// endforeach;	
			?></select>
		</div>	
