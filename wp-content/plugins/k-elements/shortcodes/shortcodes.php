 ...
 */
 /*
 * Atgoel for Order to Customer Linkage
 */
...
$k_elements = array(
    ...
    'kleo_product_customer_grid' => array(
        'name' => 'Customer Grid',
        'category' => 'buddypress',
        'example' => '[kleo_product_customer_grid member_type="all" type="newest" number="10" size="150" class=""]'
    ),
...
/**
 * Buddypress pRODUCT cUSTOMER grid.
 */

add_shortcode( "kleo_product_customer_grid", "kleo_product_customer_grid_func");
add_filter('kleo_tinymce_shortcodes', "kleo_product_customer_grid_mce");


function kleo_product_customer_grid_func($atts, $content = null) {
	
	global $kleo_config;
	$shortcode = $kleo_config['shortcodes']['kleo_product_customer_grid'];
	$output = '';
	...
	$shortcode_path = $sh_category .'kleo_product_customer_grid';
...
function kleo_product_customer_grid_mce($args) {
